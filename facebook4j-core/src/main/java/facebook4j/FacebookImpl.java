...
class FacebookImpl extends FacebookBaseImpl implements Facebook {
	...
	public ResponseList<RSVPStatus> getRSVPStatusInAttending(String eventId, Reading reading) throws FacebookException {
		ensureAuthorizationEnabled();
        return factory.createRSVPStatusList(get(buildEndpoint(eventId, "attending", reading)));
    }
    ...
    private <T> ResponseList<T> fetchPaging(URL url, Class<T> jsonObjectType) throws FacebookException {
        ...
        return factory.createResponseList(res, jsonObjectType);
    }
